<template>
  <div id="Navigation_select">
    <div class="switch_icon" @mouseenter="SelectStatus=true" @mouseleave="closeOption">
    ...
    <div
      class="selectOption"
      v-if="SelectStatus"
      @mouseenter="SelectStatus=true"
      @mouseleave="SelectStatus=false"
    >
...
export default {
  ...
  methods: {
    closeOption () {
      setTimeout(() => { this.SelectStatus = false }, 100)
    }
  },
  mounted () {
